    ...
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <form method="POST" action="/note">
                ...
                <div class="border-b border-white/10 pb-12">
                    <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="col-span-full">
                            ...
                            <p class="mt-3 text-sm/6 text-gray-400">Edit you note.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                <a href="/notes" type="submit" class="rounded-md bg-red-400 px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">Cancel</a>
